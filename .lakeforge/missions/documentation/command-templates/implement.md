...
# Command Template: /implement (Documentation Mission)
...
If `/status` shows your WP in "doing" after you moved it to "for_review", don't panic - a reviewer may have moved it back (changes requested), or there's a sync delay. Focus on your WP.
