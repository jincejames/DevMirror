#!/usr/bin/env python3
"""
Validate and fix UTF-8 encoding in Lakeforge markdown files.
...
Usage:
    python scripts/validate_encoding.py --check lakeforge-specs/
    python scripts/validate_encoding.py --fix lakeforge-specs/001-feature/
...
def main():
    ...
    parser.add_argument('path', nargs='?', default='lakeforge-specs', help='Path to scan (default: lakeforge-specs)')
