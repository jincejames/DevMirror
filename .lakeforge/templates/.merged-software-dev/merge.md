...
2. ✅ Feature must pass `/accept` checks
...
```bash
lakeforge merge ###-feature-slug [OPTIONS]
```

**Example**:
```bash
cd /tmp/lakeforge-test/test-project  # Main repo root
lakeforge merge 001-cli-hello-world
```
