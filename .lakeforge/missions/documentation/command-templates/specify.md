...
# Command Template: /specify (Documentation Mission)
...
2. **Generate feature directory**: Run `lakeforge agent feature create-feature "doc-{project-name}" --json --mission documentation`
...
7. **Report completion**: Spec file path, next command (`/plan`)
