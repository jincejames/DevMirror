...
scripts:
   sh: lakeforge agent check-prerequisites --json --paths-only
   ps: lakeforge agent -Json -PathsOnly
---
...
- **FEATURE_DIR**: Absolute path to your feature directory (lakeforge-specs/001-feature-name/)
...
**Before this**: `/specify` created spec.md (your starting requirements)
...
- Or run `/clarify` again if more questions arise post-planning
