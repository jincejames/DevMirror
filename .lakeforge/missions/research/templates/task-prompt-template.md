...
> **Populated by `/review`** – Reviewers add detailed feedback here when research needs revision. Each item must be addressed before returning for re-review.
...
- Link to supporting specs: `.lakeforge/memory/constitution.md`, `lakeforge-specs/.../plan.md` (methodology), `lakeforge-specs/.../spec.md` (research question), `research.md`, `data-model.md`.
