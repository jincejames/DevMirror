...
This location is SEPARATE from `lakeforge-specs/` planning artifacts.
...
**Do NOT use**:
- `lakeforge-specs/` (reserved for sprint planning artifacts)
...
|------|----------|---------|
| **Planning Artifacts** | `lakeforge-specs/[###]/research/` | Evidence/sources collected DURING planning (shared across WPs) |
| **Research Deliverables** | `[deliverables_path]/` | Actual research OUTPUT (created in worktrees, merged to main) |

## Project Structure

### Sprint Planning Artifacts (in lakeforge-specs/)
```
lakeforge-specs/[###-research]/
