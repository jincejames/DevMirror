...
**Note**: This template is filled in by the `/plan` command. See mission command templates for execution workflow.
...
**Note**: Phase 2 (work package generation) is handled by the `/tasks` command.
