...
- ✅ Approve: `lakeforge agent tasks move-task WP## --to done --note "Review passed: <summary>"`
- ❌ Reject: Write feedback to the temp file path shown in the prompt, then run `lakeforge agent tasks move-task WP## --to planned --review-feedback-file <temp-file-path>`
