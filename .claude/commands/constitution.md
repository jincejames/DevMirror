...
*Path: [.lakeforge/templates/commands/constitution.md](.lakeforge/templates/commands/constitution.md)*
...
Handle responses:
- **A (Skip)**: Create a minimal placeholder at `.lakeforge/memory/constitution.md`:
  - Title + short note: "Constitution skipped - not required for Lakeforge usage. Run /constitution anytime to create one."
  - Exit successfully.
...
Here's what will be written to .lakeforge/memory/constitution.md:
...
> Auto-generated by lakeforge constitution command
> Created: [YYYY-MM-DD]
> Version: 1.0.0
...
- Next steps (review, share with team, run /specify)
